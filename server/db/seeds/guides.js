  ...
  return knex('guides')
    ...
    .then(function () {
      ...
      return knex('guides').insert([
        { id: 1, name: 'Jeremiah Alfonso', bio: 'Hello my name is Jeremiah Alfonso and I am here to show you around Wellington I have been a tour guide for three years now, and during that time Ive given tours to people from all over the world - Australia, Japan, China, Russia… even America! They all come up here because of the wonders we have in this city. We are known as the \'little New Zealand\' city, but that doesn\'t mean we don\'t have anything special to offer! We can boast with our many beaches, museums, and fine dining restaurants. Not to mention, we also have the best rugby team in New Zealand! It\'s time to start your tour! Let me take you on a journey through our town.', fee: 52.50, contact_number: 6440274795922, email: 'J.Alfonso@gmail.com', picture_url: 'https://i.chzbgr.com/full/8334924288/hCFACD046/stock-photo-of-hide-the-pain-harold-looking-at-the-camera-with-a-pained-expression' },
